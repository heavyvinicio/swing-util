...
public final class ReflectionUtil implements Serializable {
     ...
     *             error
     */
    private static <T> Map<Integer, Object> convertObjectData2Map(T object, String[] attributes) throws IntrospectionException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        Map<Integer, Object> row = new TreeMap<>();
    ...
    private static <T> Map<Integer, Object> convertObjectData2Map(T object, int... columns) throws IntrospectionException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        int order = 0;
        Map<Integer, Object> row = new TreeMap<>();
        for (Field field : getFieldsObject(object)) {
            if (isStaticOrFinal(field)) {
