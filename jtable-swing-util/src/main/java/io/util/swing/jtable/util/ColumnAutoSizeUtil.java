...
/**
 * <b>Utility class for set automatic width properties . </b>
 * <p>
 * Sources from
 ...
 *          </p>
 */
public class ColumnAutoSizeUtil {
    public static void sizeColumnsToFit(JTable table) {
        sizeColumnsToFit(table, 5);
    }

    /**
     * <b> Method for setting {@link JTable} and margin column. </b>
     * <p>
     * [Author: pocho, Date: 22/09/2017]
     * </p>
     *
    ...
    /**
     * <b> Method for adjust maximun width. </b>
     * <p>
     * [Author: pocho, Date: 22/09/2017]
     * </p>
     *
    ...
    private static void adjustMaximumWidths(JTable table, int[] minWidths, int[] maxWidths) {
        if (table.getWidth() > 0) {
            ...
            int breaker = 0;
            // keep stealing one pixel of the maximum width of the
            // highest column until we can fit in the width of the
            // table
    ...
    /**
     * <b> Method for get MaximalRequiredColumnWidth. </b>
     * <p>
     * [Author: pocho, Date: 22/09/2017]
     * </p>
     *
    ...
    /**
     * <b> Method for findLargestIndex. </b>
     * <p>
     * [Author: pocho, Date: 22/09/2017]
     * </p>
     *
